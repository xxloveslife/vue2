  ...
  <div>
    <header class="w">
      <div class="w-box">
        ...
        <div class="right-box">
          <div class="nav-list">
            <el-input placeholder="请输入商品信息" suffix-icon="el-icon-search" v-model="productInfo" minlength="1" maxlength="100"></el-input>
    ...
    .shop {
        ...
        .cart-num {
            ...
            > i {
                ...
                box-shadow: inset 0 0 1px hsla(0, 0%, 100%, 0.15), 0 1px 2px hsla(0, 0%, 100%, 0.15);
                text-align: center;
                font-style: normal;
        ...
        .nav-cart-total {
            ...
            box-shadow: inset 0 -1px 0 hsla(0, 0%, 100%, 0.5), 0 -3px 8px rgba(0, 0, 0, 0.04);
